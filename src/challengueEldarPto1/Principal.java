...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// Indicando el monto de la operacion y la marca de la tarjeta, devuelve marca y tasa. En el caso de que se ingrese por teclado puede usarse el método toUpperCase() para convertir el String a mayuscula
		
		Operacion op = new Operacion(995.43, "NARA");
